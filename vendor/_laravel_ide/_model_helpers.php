...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Barang>|Barang whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Barang>|Barang whereKode($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Barang>|Barang whereNama($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Barang>|Barang whereKategori($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Barang>|Barang whereJumlah($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Barang>|Barang whereSatuan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Barang>|Barang whereHarga($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Barang>|Barang whereSupplier($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Barang>|Barang whereTanggal($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Barang>|Barang timeout(int $seconds)
     ...
     * @property mixed $total_harga
     * @property mixed $harga_satuan
     * @property mixed $jumlah
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereNamaPelanggan($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereAlamat($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereNoHp($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereNamaProduk($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereKategori($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereJumlah($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereHargaSatuan($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan whereTanggalPesan($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan menunggu() {@see App\Models\Pesanan::scopeMenunggu()}
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan selesai() {@see App\Models\Pesanan::scopeSelesai()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<Pesanan>|Pesanan timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
